package com.application.shopbasket.views.defaultpage;


import com.application.shopbasket.views.MainLayout;
import com.application.shopbasket.views.defaultpage.ServiceHealth.Status;
...
@Route(value = "default-page", layout = MainLayout.class)
public class DefaultPageView extends Main {

    public DefaultPageView() {
        addClassName("default-page-view");
